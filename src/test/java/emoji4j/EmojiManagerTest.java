...
public class EmojiManagerTest {
	...
	public void testEmojify1() {
		...
		assertThat(EmojiUtils.emojify(text)).isEqualTo("A 🐱, 🐶 and a 🐭 became friends. For 🐶's birthday party, they all had 🍔s, 🍟s, 🍪s and 🍰.");
		...
		assertThat(EmojiUtils.emojify(text)).isEqualTo("A 🐱, 🐶, :coyote: and a 🐭 became friends. For 🐶's birthday party, they all had 🍔s, 🍟s, 🍪s and 🍰.");
	...
	public void testHtmlify() {
		...
		assertThat(htmlifiedText).isEqualTo("A &#128049;, &#128054; and a &#128045; became friends. For &#128054;'s birthday party, they all had &#127828;s, &#127839;s, &#127850;s and &#127856;.");
		
		//also verify by emojifying htmlified text
		
		assertThat(EmojiUtils.emojify(htmlifiedText)).isEqualTo("A 🐱, 🐶 and a 🐭 became friends. For 🐶's birthday party, they all had 🍔s, 🍟s, 🍪s and 🍰.");
	}
